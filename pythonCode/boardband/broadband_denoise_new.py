...
(X_train, Y_train), (X_val, Y_val), (X_test, Y_test) = zelin_dataset.load_broadband_denoise("/home/uestcauto/cyy/boardband/dataset/broadband_dataset_2G10G15M.pkl")
...
# else:
torch.save(GRU_model.state_dict(), "/home/uestcauto/cyy/boardband/saved_model/broadband_dataset_2G10G15M_240.pth")
np.savetxt('/home/uestcauto/cyy/boardband/results/broadband_2G10G15M_240_loss.txt', losses)
np.savetxt('/home/uestcauto/cyy/boardband/results/broadband_2G10G15M_240_val_loss.txt', val_losses)
...
torch.onnx.export(GRU_model, dummy_input, '/home/uestcauto/cyy/boardband/saved_model/broadband_dataset_2G10G15M_240.onnx', input_names=input_names, output_names=output_names, dynamic_axes=dynamic_axes)
print("Model saved...")
#
