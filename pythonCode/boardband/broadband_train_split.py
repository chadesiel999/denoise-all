...
# ==========================================
# Modified loading logic for split datasets
# ==========================================
def load_split_dataset(data_dir):
    print(f"Loading split datasets from {data_dir}...")
    
    with open(os.path.join(data_dir, "broadband_train_random.pkl"), "rb") as f:
        train_data = pickle.load(f)
    with open(os.path.join(data_dir, "broadband_val_random.pkl"), "rb") as f:
        val_data = pickle.load(f)
    with open(os.path.join(data_dir, "broadband_test_ordered.pkl"), "rb") as f:
        test_data = pickle.load(f)

    # Data shape is (N, 2, 240, 1) -> split to X (channel 0) and Y (channel 1)
...
(X_train, Y_train), (X_val, Y_val), (X_test, Y_test) = load_split_dataset("/home/uestcauto/cyy/boardband/dataset")
...
# else:
torch.save(GRU_model.state_dict(), "/home/uestcauto/cyy/boardband/saved_model/broadband_random_100M5G11G20G25M_240.pth")
np.savetxt('/home/uestcauto/cyy/boardband/results/broadband_random_100M5G11G20G25M_240_loss.txt', losses)
np.savetxt('/home/uestcauto/cyy/boardband/results/broadband_random_100M5G11G20G25M_240_val_loss.txt', val_losses)
...
torch.onnx.export(GRU_model, dummy_input, '/home/uestcauto/cyy/boardband/saved_model/broadband_random_100M5G11G20G25M_240.onnx', input_names=input_names, output_names=output_names, dynamic_axes=dynamic_axes)
print("Model saved...")
#
