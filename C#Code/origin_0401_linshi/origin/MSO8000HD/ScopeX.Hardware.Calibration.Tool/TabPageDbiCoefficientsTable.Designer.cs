...
namespace ScopeX.Hardware.Calibration.Tool
{
    partial class TabPageDbiCoefficientsTable
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBoxCaliType.Items.AddRange(new object[] { "InterpolationCoefficients_2fold", "Level1_InterpolationCoefficients", "Level1_LocalOscillatorCoefficients", "Level1_AntiImageCoefficients", "Level2_InterpolationCoefficients", "Level2_LocalOscillatorCoefficients", "Level2_AntiImageCoefficients", "Sub_AmpCoefficientFile", "InterpolationCoefficients", "LocalOscillatorCoefficients", "AntiImageCoefficients", "FractionaryDelayCoefficients", "OverlapPhaseFreqDelayCoefficients", "TiAdc", "AmpFreqCoefficients", "PhaseFreqCoefficients", "MultiRadioInterpolationCoefficients" });
