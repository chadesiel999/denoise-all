...
namespace ScopeX.Hardware.Driver
{
    ...
    /// 模拟模拟通道波形数据
    /// </summary>
    internal class Acquirer_SimulateWave_Standard : AbstractAcquirer_SimulateWave
    {
        internal new static void SimulateAcqDataGenerator(ref ushort[] dataList, Int64 startIndex, Int32 adcBits, SimulateWaveType waveType, Int32 dataLength, Int64 samplingRate, Int32 frequencyByHz, Int32 amplitude, Int32 offset, Int32 phaseByHz)
        {
