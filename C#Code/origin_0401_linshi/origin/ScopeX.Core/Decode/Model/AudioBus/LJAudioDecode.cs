...
namespace ScopeX.Core.Decode
{
    ...
    internal class LJAudioDecode :AudioDecode
    {
        public override ProtocolAudioBus.SubType SubType => ProtocolAudioBus.SubType.LJ;
        public LJAudioDecode(AudioBusDecodeModel model) : base(model)
        {
        }
