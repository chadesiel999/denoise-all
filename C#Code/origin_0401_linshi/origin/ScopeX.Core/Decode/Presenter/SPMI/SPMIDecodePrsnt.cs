...
{
    public class SPMIDecodePrsnt : ProtocolPrsnt
    {
        public SPMIDecodePrsnt(ChannelId id, IDsoPrsnt idp, IProtocolView? view, Boolean isTrigDecode = false) : base(idp, view)
        {
            Model = (SPMIDecodeModel)DecodeTools.GetChannelDecodeModel(id, SerialProtocolType.SPMI);
        ...
        private protected override SPMIDecodeModel Model { get; }
