...
{
    internal class AiGraphModel : AdvancedMathModel
    {
        public AiGraphModel(String formula) : base(formula)
        {

        }
        public AiGraphModel(String formula, DrawMethod drawMethod) : base(formula, drawMethod)
        {
        ...
        public override WfmProperties Config(MathModel mch, string exp, Vector? vec)
        {
            ...
            mch.Conditioning.ScaleMaxIndex = 80;//正向调节  30次
            mch.Conditioning.ScaleMinIndex = -80;//负向调节  -20次
