...
namespace ScopeX.U2
{
    internal class UiSpecialMSO7000X : IPlatformUI
    {
        ...
        {
            Keyboard.Default.PreProcess(KeyCode.SETTING);
        }

        public void KeyEnumTriggerHandler()
        {
            Keyboard.Default.PreProcess(KeyCode.TRIGGER);
        }
