...
namespace ScopeX.U2
{
    ...
    /// <summary>
    /// Defines the <see cref="Page8000HD" />.
    /// </summary>
    public partial class Page8000HD : UserControl, IkeyBoardDetetionView//, IStylize//ISystemCheckView
    {
        //[Browsable(false)]
        ...
        private Color _DefaultColor = Color.Silver;
        private Color _KeyPressedColor = Color.LimeGreen;//Color.Lime;
        private Color _CircDefaultColor = Color.FromArgb(64, 64, 64);
        ...
        private void InitControl()
        {
            ...
            BtnAutoset.BackColor = _DefaultColor;
            BtnSingle.BackColor = _DefaultColor;
            BtnNormal.BackColor = _DefaultColor;
            BtnAuto.BackColor = _DefaultColor;

            BtnPushToFine.BackColor = _DefaultColor;
            BtnForce.BackColor = _DefaultColor;
            ...
            BtnUtility.BackColor = _DefaultColor;
            BtnDefault.BackColor = _DefaultColor;
            BtnAPP.BackColor = _DefaultColor;
            BtnScreenshot.BackColor = _DefaultColor;
            BtnClear.BackColor = _DefaultColor;
        ...
        private void SetControlColor()
        {
            ...
            switch (Presenter.KeyCheckCode)
            {
                ...
                case KeyCode.AUTOSET:
                    ...
                    {
                        BtnAutoset.BackColor = _DefaultColor;
                        BtnAutoset.MouseinBackColor = _DefaultColor;
                        BtnAutoset.PressedBackColor = _DefaultColor;
                    }
                    break;
                case KeyCode.SINGLE:
                ...
                case KeyCode.TRIGGER:
                    ...
                    {
                        BtnPushToFine.BackColor = _KeyPressedColor;
                        BtnPushToFine.MouseinBackColor = _KeyPressedColor;
                        BtnPushToFine.PressedBackColor = _KeyPressedColor;
                    }
                    else
                    {
                        BtnPushToFine.BackColor = _DefaultColor;
                        BtnPushToFine.MouseinBackColor = _DefaultColor;
                        BtnPushToFine.PressedBackColor = _DefaultColor;
                    }
                    break;
                case KeyCode.TRIG_FORCE:
                    ...
                    {
                        BtnForce.BackColor = _DefaultColor;
                        BtnForce.MouseinBackColor = _DefaultColor;
                        BtnForce.PressedBackColor = _DefaultColor;
                    }
                    break;
                ...
                case KeyCode.VK_APPS:
                    ...
                    {
                        BtnAPP.BackColor = _DefaultColor;
                        BtnAPP.MouseinBackColor = _DefaultColor;
                        BtnAPP.PressedBackColor = _DefaultColor;
                    }
                    break;
                case KeyCode.TOUCH:
                ...
                case KeyCode.VK_SCREENSHOT:
                    ...
                    {
                        BtnScreenshot.BackColor = _DefaultColor;
                        BtnScreenshot.MouseinBackColor = _DefaultColor;
                        BtnScreenshot.PressedBackColor = _DefaultColor;
                    }
                    break;
                case KeyCode.SETTING:
                    ...
                    {
                        BtnUtility.BackColor = _DefaultColor;
                        BtnUtility.MouseinBackColor = _DefaultColor;
                        BtnUtility.PressedBackColor = _DefaultColor;
                    }
                    break;
                ...
                case KeyCode.VK_CLEAR:
                    ...
                    {
                        BtnClear.BackColor = _DefaultColor;
                        BtnClear.MouseinBackColor = _DefaultColor;
                        BtnClear.PressedBackColor = _DefaultColor;
                    }
                    break;
                case KeyCode.DEFAULT:
                    ...
                    {
                        BtnDefault.BackColor = _DefaultColor;
                        BtnDefault.MouseinBackColor = _DefaultColor;
                        BtnDefault.PressedBackColor = _DefaultColor;
                    }
                    break;
