...
{
    public partial class SearchWindowSubPage : UserControl, ITriggerView, IStylize
    {
        private Boolean _ArgToCtrl;
        public SearchWindowSubPage(SearchWindowPrsnt prsnt)
        {
            InitializeComponent();
            Presenter = prsnt;
            Init();
        ...
        public SearchWindowPrsnt Presenter
        {
            get;
            set;
        }
        ...
        ITriggerPrsnt IView<ITriggerPrsnt>.Presenter { get => Presenter; set => Presenter = (SearchWindowPrsnt)value; }
