namespace ScopeX.U2.Search
{
    ...
    public partial class SearchTransitionSubPage : UserControl, ITriggerView, IStylize
    {
        private Boolean _ArgToCtrl;


        public SearchTransitionSubPage(SearchTransitionPrsnt prsnt)
        {
            InitializeComponent();
            Presenter = prsnt;
        }

        public SearchTransitionPrsnt Presenter
        {
            get;
            set;
        }
        ...
        ITriggerPrsnt IView<ITriggerPrsnt>.Presenter { get => Presenter; set => Presenter = (SearchTransitionPrsnt)value; }
        ...
        public void UpdateView(Object prsnt, String propertyName)
        {
            ...
            switch (propertyName)
            {
                ...
                case nameof(Presenter.TransSlope):
                    RdoSlope.ChoosedButtonIndex = (Int32)Presenter.TransSlope;
                    break;
            }
            _ArgToCtrl = false;
        }
        ...
        private void Init()
        {
            ...
            NebBelowPos.StringFormatFunc = (_) => CompPosToString(Presenter.LowerCompPosition);
        ...
        private void RdoSlope_IndexChanged(object sender, EventArgs e)
        {
            if (!_ArgToCtrl)
            {
                Presenter.TransSlope = (EdgeSlope)RdoSlope.ChoosedButtonIndex;
            }
        }
