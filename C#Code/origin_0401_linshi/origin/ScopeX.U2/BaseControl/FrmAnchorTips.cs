...
namespace ScopeX.U2
{
    ...
    public partial class FrmAnchorTips : Form, IStylize
    {
        #region 私有字段
        ...
        private void ResetForm(String strMsg)
        {
            ...
            Font _font = new Font(ScopeX.Controls.Language.LanguageManger.Instance.GetIDMessage("WeiRuanYaHei"), m_fontSize);
            ...
            SizeF sizeText = g.MeasureString(strMsg, _font);
            g.Dispose();
            var formSize = new Size((Int32)sizeText.Width + 10, (Int32)sizeText.Height + 10);
        ...
        private static Boolean CheckControlClose(Control c)
        {
        ...
        /// The wm activate
        /// </summary>
        private const Int32 WM_ACTIVATE = 0x006;

        /// <summary>
        /// The wm activateapp
        /// </summary>
        private const Int32 WM_ACTIVATEAPP = 0x01C;

        /// <summary>
        /// The wm ncactivate
        /// </summary>
        private const Int32 WM_NCACTIVATE = 0x086;
        ...
        /// </summary>
        private const Int32 WM_MOUSEACTIVATE = 0x21;

        /// <summary>
        /// The ma noactivate
        /// </summary>
        private const Int32 MA_NOACTIVATE = 3;
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            {
                if (((Int32)m.WParam & 0xFFFF) != WA_INACTIVE)
                {
    ...
    internal class Win32
    {
        ...
        /// <returns>System.Int32.</returns>
        [DllImport("gdi32.dll", ExactSpelling = true, SetLastError = true)]
        public static extern Int32 DeleteObject(IntPtr hObj);
        ...
        /// <returns>System.Int32.</returns>
        [DllImport("user32.dll", ExactSpelling = true, SetLastError = true)]
        public static extern Int32 UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDst, ref Point pptDst, ref Size psize, IntPtr hdcSrc, ref Point pptSrc, Int32 crKey, ref BLENDFUNCTION pblend, Int32 dwFlags);
