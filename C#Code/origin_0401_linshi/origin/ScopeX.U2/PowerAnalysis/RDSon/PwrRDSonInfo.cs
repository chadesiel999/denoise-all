...
namespace ScopeX.U2
{
    [DefaultEvent("Click")]
    [DefaultValue("Text")]
    public partial class PwrRDSonInfo : UserControl, IPwrAnalysisView, IChannelInfoStyle
    {
        #region 多语言资源Key名称
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            TextRenderer.DrawText(
                ...
                ContentFont,
                new Rectangle(NameWidth - 1, y, w, h),
                cfc,
                TextFormatFlags.Right | TextFormatFlags.VerticalCenter);
        ...
        private void OnBodyClicked()
        {
            ...
            (Program.Oscilloscope.View as DsoForm).MakeOperateForm(Presenter.Id.ToString() + "(" + name + ")", PointToScreen(new Point(Width / 2, 0)), PopOrientation.Above, () =>
            {
                ...
                var form = new PwrRDSonForm(poweranalysisprsnt)
                {
