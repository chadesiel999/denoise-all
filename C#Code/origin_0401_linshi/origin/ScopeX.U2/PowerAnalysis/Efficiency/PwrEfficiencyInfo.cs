...
namespace ScopeX.U2
{
    [DefaultEvent("Click")]
    [DefaultValue("Text")]
    public partial class PwrEfficiencyInfo : UserControl, IPwrAnalysisView, IChannelInfoStyle
    {
        #region 多语言资源Key名称
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            string str = ScopeX.Controls.Language.LanguageManger.Instance.GetIDMessage("DianYuanXiaoLv");
            TextRenderer.DrawText(e.Graphics,
                str,
                ContentFont,
            ...
            msg = $"{Presenter.VoltageSrc1}/{Presenter.CurrentSrc1}";
            TextRenderer.DrawText(
                e.Graphics,
                msg,
                ContentFont,
            ...
            msg = $"{Presenter.VoltageSrc2}/{Presenter.CurrentSrc2}";
            TextRenderer.DrawText(
                e.Graphics,
                msg,
                ContentFont,
            ...
            msg = $"{Presenter.BoundMathPrsnt1?.Id}/{Presenter.BoundMathPrsnt2?.Id}";
            TextRenderer.DrawText(
                e.Graphics,
               msg,
                ContentFont,
        ...
        private void OnBodyClicked()
        {
            ...
            (Program.Oscilloscope.View as DsoForm).MakeOperateForm(Presenter.Id.ToString() + "(" + name + ")", PointToScreen(new Point(Width / 2, 0)), PopOrientation.Above, () =>
            {
                ...
                var form = new PwrEfficiencyForm(poweranalysisprsnt)
                {
