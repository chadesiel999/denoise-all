...
namespace ScopeX.U2
{
    public partial class PwrEfficiencyGuideForm : FlashBorderForm
    {
        public PwrEfficiencyGuideForm()
        {
            InitializeComponent();
            IsShowPin = false;
        ...
        private void PwrEfficiencyGuideForm_Load(object sender, EventArgs e)
        {
