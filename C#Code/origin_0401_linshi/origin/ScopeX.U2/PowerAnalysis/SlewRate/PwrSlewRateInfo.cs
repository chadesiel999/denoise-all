...
namespace ScopeX.U2
{
    [DefaultEvent("Click")]
    [DefaultValue("Text")]
    public partial class PwrSlewRateInfo : UserControl, IPwrAnalysisView, IChannelInfoStyle
    {
        #region 多语言资源Key名称
                    ...
                    case nameof(Presenter.Active):
                        {
                            if (!Presenter.Active)
                            {
                                ...
                                Presenter.BoundMathPrsnt2.Active = false;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            string str = LanguageManger.Instance.GetIDMessage("ZhuanHuanSuLv");
            TextRenderer.DrawText(e.Graphics,
                str,
                ContentFont,
            ...
            if (Presenter.VoltageSrc1 == ComModel.ChannelId.C1)
            {
                width = NameWidth - 2;
            }
            TextRenderer.DrawText(
            ...
            TextRenderer.DrawText(
                ...
                TextFormatFlags.Left | TextFormatFlags.VerticalCenter);
            width = NameWidth;
            if (Presenter.CurrentSrc1 == ComModel.ChannelId.C1)
            {
                width = NameWidth - 2;
            }
            TextRenderer.DrawText(
            ...
            //信息第二行
            y += h;
            String msg = $"dv/dt:{Presenter.BoundMathPrsnt1.Id}";
            TextRenderer.DrawText(
                e.Graphics,
                msg,
                ContentFont,
            ...
            msg = $"di/dt:{Presenter.BoundMathPrsnt2.Id}";
            TextRenderer.DrawText(
                e.Graphics,
                msg,
                ContentFont,
                new Rectangle(NameWidth - 4, y, w + 5, h),
                cfc,
                TextFormatFlags.Right | TextFormatFlags.VerticalCenter);
            #endregion
        ...
        private void OnBodyClicked()
        {
            ...
            (Program.Oscilloscope.View as DsoForm).MakeOperateForm(Presenter.Id.ToString() + "(" + name + ")", PointToScreen(new Point(Width / 2, 0)), PopOrientation.Above, () =>
            {
                ...
                var form = new PwrSlewRateForm(poweranalysisprsnt)
                {
