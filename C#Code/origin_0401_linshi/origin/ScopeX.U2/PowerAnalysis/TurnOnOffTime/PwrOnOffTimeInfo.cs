...
namespace ScopeX.U2
{
    [DefaultEvent("Click")]
    [DefaultValue("Text")]
    public partial class PwrOnOffTimeInfo : UserControl, IPwrAnalysisView, IChannelInfoStyle
    {
        #region 多语言资源Key名称
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            string str = LanguageManger.Instance.GetIDMessage("KaiQiGuanBiShiJian");
            TextRenderer.DrawText(e.Graphics,
                str,
                ContentFont,
        ...
        private void OnBodyClicked()
        {
            ...
            (Program.Oscilloscope.View as DsoForm).MakeOperateForm(Presenter.Id.ToString() + "(" + name + ")", PointToScreen(new Point(Width / 2, 0)), PopOrientation.Above, () =>
            {
                ...
                var form = new PwrOnOffTimeForm(poweranalysisprsnt)
                {
