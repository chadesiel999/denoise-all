...
namespace ScopeX.U2
{
    public partial class PwrLoopAnalysisPage : UserControl, IPwrOptionView, IStylize
    {
        private Boolean _ArgToCtrl;
        private AmplitudeSettingForm _AmplitudeSettingForm;
        public PwrLoopAnalysisPage()
        {
            InitializeComponent();
        ...
        private void InitComboxList()
        {
            ...
            CbxInputSrc.DataSource = dss;
            //selectTouch1.SelectValue = PowerPresenter.VoltageSrc;
            //selectTouch1.Text = PowerPresenter.VoltageSrc.ToString();

            CbxInputSrc.SelectedIndexChanged += (_, _) =>
            {
                if (!_ArgToCtrl)
                {
                    PowerPresenter.VoltageSrc1 = (ChannelId)CbxInputSrc.SelectValue;
                }
            };

            CbxOutputSrc.DataSource = dss;
            //selectTouch2.SelectValue = PowerPresenter.CurrentSrc;
            //selectTouch2.Text = PowerPresenter.CurrentSrc.ToString();

            CbxOutputSrc.SelectedIndexChanged += (_, _) =>
            {
                if (!_ArgToCtrl)
                {
                    PowerPresenter.CurrentSrc1 = (ChannelId)CbxOutputSrc.SelectValue;
                }
            };
        ...
        public PwrLoopAnalysisPrsnt Presenter
        {
            get;
            set;
        }
        IPwrOptionPrsnt IView<IPwrOptionPrsnt>.Presenter
        {
            ...
            set
            {
                Presenter = (PwrLoopAnalysisPrsnt)value;
            }
        }
        ...
        protected void Update(Object prsnt, String propertyName)
        {
            ...
            switch (propertyName)
            {
                ...
                case nameof(PowerPresenter.VoltageSrc1):
                    ...
                    CbxInputSrc.SelectValue = PowerPresenter.VoltageSrc1;
                    break;
                case nameof(PowerPresenter.CurrentSrc1):
                    //CbxCurrentSrc.SelectedIndex = (Int32)Presenter.OutputSource;
                    CbxOutputSrc.SelectValue = PowerPresenter.CurrentSrc1;
                    break;
        ...
        {
            PowerAnalysisApp.TryShowLoopAnalysisGuideForm();
        }
        ...
        {
            (Program.Oscilloscope.View as DsoForm).TryAddLoopAnalysisUI(PowerPresenter);
        ...
        private void BtnAmplitudeSetting_Click(object sender, EventArgs e)
        {
           ...
           (ParentForm as PwrLoopAnalysisForm).CanClose = false;
            _AmplitudeSettingForm.ShowDialogByPosition();
            (ParentForm as PwrLoopAnalysisForm).CanClose = true;
        }
