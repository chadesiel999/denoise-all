...
namespace ScopeX.U2
{
    public partial class PwrLoopAnalysisForm : FloatForm, IPwrAnalysisView
    {
        private PwrLoopAnalysisPage _PwrPSRRPage;
        public PwrLoopAnalysisForm(PowerAnalysisPrsnt powerAnalysisPrsnt)
        {
            InitializeComponent();
            ...
            _PwrPSRRPage = new()
            {
                ...
                Presenter = Presenter.LoopAnalysisPrsnt.Value
            };
            Size = new(_PwrPSRRPage.Size.Width, _PwrPSRRPage.Size.Height + HeadHeight);
            _PwrPSRRPage.Presenter.TryAddView(_PwrPSRRPage);
            Controls.Add(_PwrPSRRPage);
            Controls.SetChildIndex(_PwrPSRRPage, 0);
            HelpClick += (_, _) =>
            {
                ...
                //    return;
                //}
                HelpProcessManager.SendCommand(HelpDocumentManager.Default.GetCommand(nameof(PwrLoopAnalysisForm)));
            };
        }
        ...
        protected void Update(Object prsnt, String propertyName)
        {
            ...
            _PwrPSRRPage.UpdateView(prsnt, propertyName);
        }
