...
namespace ScopeX.U2
{
    public partial class PwrModulationGuideForm : FlashBorderForm
    {
        public PwrModulationGuideForm()
        {
            InitializeComponent();
            IsShowPin=false;
        ...
        private void PwrModulationGuideForm_Load(object sender, EventArgs e)
        {
