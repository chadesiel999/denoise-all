...
namespace ScopeX.U2
{
    ...
    public partial class PwrModulationForm : FloatForm, IPwrAnalysisView
    {
        private PwrModulationPage _PwrModulationPage;
        public PwrModulationForm(PowerAnalysisPrsnt powerAnalysisPrsnt)
        {
            InitializeComponent();
            ...
            _PwrModulationPage = new()
            {
                BackColor = Color.Transparent,
                Dock = DockStyle.Fill,
                PowerPresenter = Presenter,
                Presenter = Presenter.ModulationPrsnt.Value
            };
            _PwrModulationPage.Presenter.TryAddView(_PwrModulationPage);
            Size = new(_PwrModulationPage.Size.Width, _PwrModulationPage.Size.Height + HeadHeight);

            Controls.Add(_PwrModulationPage);
            Controls.SetChildIndex(_PwrModulationPage, 0);
            HelpClick += (_, _) =>
            {
                ...
                //    return;
                //}
                HelpProcessManager.SendCommand(HelpDocumentManager.Default.GetCommand(nameof(PwrModulationForm)));
            };
        }
        ...
        protected void Update(Object prsnt, String propertyName)
        {
            ...
            _PwrModulationPage.UpdateView(prsnt, propertyName);
        }
        ...
        {
            _PwrModulationPage.StylizeFlag = true;
