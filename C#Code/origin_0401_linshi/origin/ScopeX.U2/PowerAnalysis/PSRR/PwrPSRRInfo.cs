...
namespace ScopeX.U2
{
    [DefaultEvent("Click")]
    [DefaultValue("Text")]
    public partial class PwrPSRRInfo : UserControl, IPwrAnalysisView, IChannelInfoStyle
    {
        #region 多语言资源Key名称
                    ...
                    case nameof(Presenter.Active):
                        {
                            if (!Presenter.Active)
                            {
                                ...
                                (Program.Oscilloscope.View as DsoForm).TryRemovePSRRUI(Presenter.PSRRPrsnt.Value);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //TextRenderer.DrawText(
            //    e.Graphics,
            //    Presenter.CurrentSrc2.ToString(),
            //    ContentFont,
            //    new Rectangle(NameWidth, y, w, h),
            //    cfc,
            //    TextFormatFlags.Right | TextFormatFlags.VerticalCenter);
        ...
        private void OnBodyClicked()
        {
            ...
            (Program.Oscilloscope.View as DsoForm).MakeOperateForm(Presenter.Id.ToString() + "(" + name + ")", PointToScreen(new Point(Width / 2, 0)), PopOrientation.Above, () =>
            {
                ...
                {
                    var form = new PwrPSRRForm(poweranalysisprsnt)
                    {
