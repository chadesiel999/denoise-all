...
namespace ScopeX.U2
{
    public partial class PwrPSRRForm : FloatForm, IPwrAnalysisView
    {
        private PwrPSRRPage _PwrPSRRPage;
        public PwrPSRRForm(PowerAnalysisPrsnt powerAnalysisPrsnt)
        {
            InitializeComponent();
            ...
            _PwrPSRRPage = new()
            {
                ...
                Presenter = Presenter.PSRRPrsnt.Value
            };
            ...
            HelpClick += (_, _) =>
            {
                ...
                //    return;
                //}
                HelpProcessManager.SendCommand(HelpDocumentManager.Default.GetCommand(nameof(PwrPSRRForm)));
            };
        }
