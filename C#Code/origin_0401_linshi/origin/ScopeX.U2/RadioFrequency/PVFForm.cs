...
namespace ScopeX.U2
{
    public partial class PVFForm : FloatForm, IChnlView
    {
        private readonly PVFPage _PVFPage;
        ...
        public PVFForm()
        {
            ...
            Size = new(_PVFPage.Size.Width, _PVFPage.Size.Height + HeadHeight);
            Controls.Add(_PVFPage);
            Controls.SetChildIndex(_PVFPage, 0);
        }
        ...
        protected void Update(Object prsnt, String propertyName)
        {
            ...
            _PVFPage.UpdateView(prsnt, propertyName);
