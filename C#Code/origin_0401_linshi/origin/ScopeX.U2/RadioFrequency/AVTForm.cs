...
namespace ScopeX.U2
{
    public partial class AVTForm : FloatForm, IChnlView
    {
        private readonly AVTPage _AVTPage;
        ...
        public AVTForm()
        {
            ...
            Size = new(_AVTPage.Size.Width, _AVTPage.Size.Height + HeadHeight);
            Controls.Add(_AVTPage);
            Controls.SetChildIndex(_AVTPage, 0);
        }
        ...
        protected void Update(Object prsnt, String propertyName)
        {
            ...
            _AVTPage.UpdateView(prsnt, propertyName);
        }
