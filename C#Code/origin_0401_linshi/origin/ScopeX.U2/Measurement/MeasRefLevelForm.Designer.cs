...
namespace ScopeX.U2
{
    partial class MeasRefLevelForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "MeasRefLevelForm";
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            Text = ScopeX.Controls.Language.LanguageManger.Instance.GetIDMessage("CanKaoDianPingSheZhi");
            Title = ScopeX.Controls.Language.LanguageManger.Instance.GetIDMessage("CanKaoDianPingSheZhi");
