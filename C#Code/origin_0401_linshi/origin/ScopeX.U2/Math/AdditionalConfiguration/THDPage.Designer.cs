namespace ScopeX.U2
{
    partial class THDPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            NebChannelCount = new ScopeX.UserControls.ScopeXNumericEditBox();
            NebChannelSpacing = new ScopeX.UserControls.ScopeXNumericEditBox();
            NebChannelSpan = new ScopeX.UserControls.ScopeXNumericEditBox();
            LblChannelCount = new ScopeX.UserControls.ScopeXLabel();
            LblChannelSpacing = new ScopeX.UserControls.ScopeXLabel();
            ...
            // NebChannelCount
            // 
            NebChannelCount.AddButtonImg = null;
            ...
            NebChannelCount.AddButtonStyle = buttonStyle1;
            NebChannelCount.AddButtonVisibility = false;
            NebChannelCount.AllwaysShowFocusImage = false;
            NebChannelCount.BackColor = System.Drawing.Color.FromArgb(53, 54, 58);
            NebChannelCount.BorderColor = System.Drawing.Color.FromArgb(53, 54, 58);
            NebChannelCount.BorderThickness = 0;
            NebChannelCount.DisableHoldOnInput = false;
            NebChannelCount.DropKey = System.Windows.Forms.Keys.Space;
            NebChannelCount.FocusBoederColor = System.Drawing.Color.FromArgb(53, 54, 58);
            NebChannelCount.FocusForeColor = System.Drawing.Color.FromArgb(0, 157, 255);
            NebChannelCount.FocusImage = null;
            NebChannelCount.FocusImagePosition = ScopeX.UserControls.ScopeXNumericEditBox.FocusImagePositionEnum.Left;
            NebChannelCount.FocusImageRect = new System.Drawing.Rectangle(0, 0, 0, 0);
            NebChannelCount.Font = new System.Drawing.Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point);
            NebChannelCount.ForeColor = System.Drawing.Color.FromArgb(185, 192, 199);
            NebChannelCount.Height = 30;
            NebChannelCount.HoldOnSpeedLevel = 10;
            NebChannelCount.IconWidthProportion = 1F;
            NebChannelCount.Interval = 0.1D;
            NebChannelCount.LanguageKey = null;
            NebChannelCount.LanguagePattern = ScopeX.Controls.LanguageDefinition.LanguagePattern.Ignore;
            NebChannelCount.Location = new System.Drawing.Point(10, 216);
            NebChannelCount.MaxValue = double.MaxValue;
            NebChannelCount.MinValue = double.MinValue;
            NebChannelCount.Name = "NebChannelCount";
            NebChannelCount.Size = new System.Drawing.Size(133, 30);
            NebChannelCount.StringFormatFunc = null;
            NebChannelCount.StyleFlags = ScopeX.UserControls.Style.StyleFlag.None;
            NebChannelCount.StylizeFlag = true;
            NebChannelCount.SubButtonImg = null;
            ...
            NebChannelCount.SubButtonStyle = buttonStyle2;
            NebChannelCount.SubButtonVisibility = false;
            NebChannelCount.TabIndex = 90;
            NebChannelCount.Value = 0D;
            // 
            // NebChannelSpacing
            // 
            NebChannelSpacing.AddButtonImg = null;
            ...
            NebChannelSpacing.AddButtonStyle = buttonStyle3;
            NebChannelSpacing.AddButtonVisibility = false;
            NebChannelSpacing.AllwaysShowFocusImage = false;
            NebChannelSpacing.BackColor = System.Drawing.Color.FromArgb(53, 54, 58);
            NebChannelSpacing.BorderColor = System.Drawing.Color.FromArgb(53, 54, 58);
            NebChannelSpacing.BorderThickness = 0;
            NebChannelSpacing.DisableHoldOnInput = false;
            NebChannelSpacing.DropKey = System.Windows.Forms.Keys.Space;
            NebChannelSpacing.FocusBoederColor = System.Drawing.Color.FromArgb(53, 54, 58);
            NebChannelSpacing.FocusForeColor = System.Drawing.Color.FromArgb(0, 157, 255);
            NebChannelSpacing.FocusImage = null;
            NebChannelSpacing.FocusImagePosition = ScopeX.UserControls.ScopeXNumericEditBox.FocusImagePositionEnum.Left;
            NebChannelSpacing.FocusImageRect = new System.Drawing.Rectangle(0, 0, 0, 0);
            NebChannelSpacing.Font = new System.Drawing.Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point);
            NebChannelSpacing.ForeColor = System.Drawing.Color.FromArgb(185, 192, 199);
            NebChannelSpacing.Height = 30;
            NebChannelSpacing.HoldOnSpeedLevel = 10;
            NebChannelSpacing.IconWidthProportion = 1F;
            NebChannelSpacing.Interval = 0.1D;
            NebChannelSpacing.LanguageKey = null;
            NebChannelSpacing.LanguagePattern = ScopeX.Controls.LanguageDefinition.LanguagePattern.Ignore;
            NebChannelSpacing.Location = new System.Drawing.Point(10, 154);
            NebChannelSpacing.MaxValue = double.MaxValue;
            NebChannelSpacing.MinValue = double.MinValue;
            NebChannelSpacing.Name = "NebChannelSpacing";
            NebChannelSpacing.Size = new System.Drawing.Size(133, 30);
            NebChannelSpacing.StringFormatFunc = null;
            NebChannelSpacing.StyleFlags = ScopeX.UserControls.Style.StyleFlag.None;
            NebChannelSpacing.StylizeFlag = true;
            NebChannelSpacing.SubButtonImg = null;
            ...
            NebChannelSpacing.SubButtonStyle = buttonStyle4;
            NebChannelSpacing.SubButtonVisibility = false;
            NebChannelSpacing.TabIndex = 89;
            NebChannelSpacing.Value = 0D;
            // 
            // NebChannelSpan
            // 
            ...
            NebChannelSpan.AddButtonStyle = buttonStyle5;
            ...
            NebChannelSpan.SubButtonStyle = buttonStyle6;
            NebChannelSpan.SubButtonVisibility = false;
            NebChannelSpan.TabIndex = 88;
            NebChannelSpan.Value = 0D;
            // 
            // LblChannelCount
            // 
            LblChannelCount.BackColor = System.Drawing.Color.FromArgb(41, 42, 45);
            LblChannelCount.BorderColor = System.Drawing.Color.FromArgb(53, 54, 58);
            LblChannelCount.BorderThickness = 0;
            LblChannelCount.CornerRadius = 0;
            LblChannelCount.Font = new System.Drawing.Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point);
            LblChannelCount.ForeColor = System.Drawing.Color.FromArgb(232, 234, 237);
            LblChannelCount.HighlightPrompt = defaultHighlightPrompt2;
            LblChannelCount.LanguagePattern = ScopeX.Controls.LanguageDefinition.LanguagePattern.Default;
            LblChannelCount.Location = new System.Drawing.Point(10, 192);
            LblChannelCount.MultyLineFlag = false;
            LblChannelCount.Name = "LblChannelCount";
            LblChannelCount.Size = new System.Drawing.Size(115, 18);
            LblChannelCount.StyleFlags = ScopeX.UserControls.Style.StyleFlag.None;
            LblChannelCount.StylizeFlag = true;
            LblChannelCount.TabIndex = 87;
            LblChannelCount.TabStop = false;
            LblChannelCount.Text = ScopeX.Controls.Language.LanguageManger.Instance.GetIDMessage("TongDaoShuLiang");
            LblChannelCount.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            LblChannelCount.Token = null;
            // 
            // LblChannelSpacing
            // 
            LblChannelSpacing.BackColor = System.Drawing.Color.FromArgb(41, 42, 45);
            LblChannelSpacing.BorderColor = System.Drawing.Color.FromArgb(53, 54, 58);
            LblChannelSpacing.BorderThickness = 0;
            LblChannelSpacing.CornerRadius = 0;
            LblChannelSpacing.Font = new System.Drawing.Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point);
            LblChannelSpacing.ForeColor = System.Drawing.Color.FromArgb(232, 234, 237);
            LblChannelSpacing.HighlightPrompt = defaultHighlightPrompt3;
            LblChannelSpacing.LanguagePattern = ScopeX.Controls.LanguageDefinition.LanguagePattern.Default;
            LblChannelSpacing.Location = new System.Drawing.Point(10, 130);
            LblChannelSpacing.MultyLineFlag = false;
            LblChannelSpacing.Name = "LblChannelSpacing";
            LblChannelSpacing.Size = new System.Drawing.Size(115, 18);
            LblChannelSpacing.StyleFlags = ScopeX.UserControls.Style.StyleFlag.None;
            LblChannelSpacing.StylizeFlag = true;
            LblChannelSpacing.TabIndex = 86;
            LblChannelSpacing.TabStop = false;
            LblChannelSpacing.Text = ScopeX.Controls.Language.LanguageManger.Instance.GetIDMessage("TongDaoJianGe");
            LblChannelSpacing.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            LblChannelSpacing.Token = null;
            // 
            // LblChannelSpan
            // 
            ...
            LblChannelSpan.HighlightPrompt = defaultHighlightPrompt4;
            ...
            Controls.Add(NebChannelCount);
            Controls.Add(NebChannelSpacing);
            Controls.Add(NebChannelSpan);
            Controls.Add(LblChannelCount);
            Controls.Add(LblChannelSpacing);
        ...
        private ScopeX.UserControls.ScopeXNumericEditBox NebChannelCount;
        private ScopeX.UserControls.ScopeXNumericEditBox NebChannelSpacing;
        private ScopeX.UserControls.ScopeXNumericEditBox NebChannelSpan;
        private ScopeX.UserControls.ScopeXLabel LblChannelCount;
        private ScopeX.UserControls.ScopeXLabel LblChannelSpacing;
