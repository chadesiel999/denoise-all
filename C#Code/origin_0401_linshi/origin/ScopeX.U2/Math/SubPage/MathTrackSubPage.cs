...
namespace ScopeX.U2
{
    ...
    public partial class MathTrackSubPage :MathSubPageBase
    {
        MathTrackArg Arg;

        public MathTrackSubPage()
        {
            InitializeComponent();
        }
        ...
        {
            base.LoadMethod();
            Arg = (MathTrackArg)Presenter.GetOrMakeArg(MathType.Track);
            UpdateView();
        ...
        private void BtnMeasItem_Click(object sender, EventArgs e)
        {
            ...
            //mcf.Presenter.TryAddView(mcf);

            //mcf.ShowDialogByPosition();
