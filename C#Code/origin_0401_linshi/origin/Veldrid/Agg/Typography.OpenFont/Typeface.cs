...
namespace Typography.OpenFont
{
    ...
    public partial class Typeface
    {
        ...
        public string FamilyName => string.IsNullOrEmpty(_nameEntry.TypographicFamilyName)?_nameEntry.FontName:_nameEntry.TypographicFamilyName;
        public string FontSubFamily => string.IsNullOrEmpty(_nameEntry.TypographyicSubfamilyName)?_nameEntry.FontSubFamily:_nameEntry.TypographyicSubfamilyName;
