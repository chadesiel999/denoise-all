...
namespace Veldrid.Sdl2
{
    public static unsafe partial class Sdl2Native
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate SDL_Renderer SDL_GetRenderer_t(SDL_Window* window);
        private static SDL_GetRenderer_t s_sdl_getRenderer
            = LoadFunction<SDL_GetRenderer_t>("SDL_GetRenderer");
        public static SDL_Renderer SDL_GetRenderer(SDL_Window window) => s_sdl_getRenderer(&window);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate int SDL_GetRendererOutputSize_t(SDL_Renderer* render,int* width,int* height);
        private static SDL_GetRendererOutputSize_t s_sdl_getRendererOutputSize
            = LoadFunction<SDL_GetRendererOutputSize_t>("SDL_GetRendererOutputSize");
        public static int SDL_GetRendererOutputSize(SDL_Renderer render,int* width,int* height) => s_sdl_getRendererOutputSize(&render,width,height);
