...
namespace Veldrid.Sdl2
{
    public static unsafe partial class Sdl2Native
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void SDL_GetWindowSizeInPixels_t(SDL_Window SDL2Window, int* w, int* h);
        private static SDL_GetWindowSizeInPixels_t s_getWindowSizeInPixels = LoadFunction<SDL_GetWindowSizeInPixels_t>("SDL_GetWindowSize");
        public static void SDL_GetWindowSizeInPixels(SDL_Window Sdl2Window, int* w, int* h) => s_getWindowSizeInPixels(Sdl2Window, w, h);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
