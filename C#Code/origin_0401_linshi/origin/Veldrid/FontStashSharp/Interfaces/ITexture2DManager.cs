...
namespace FontStashSharp.Interfaces
{
	...
	public interface ITexture2DManager
	{
		...
		/// <returns></returns>
		Veldrid.Texture CreateTexture(int width, int height);
		...
		/// <returns></returns>
		Size GetTextureSize(Veldrid.Texture texture);
		...
		void SetTextureData(Veldrid.Texture texture, Rectangle bounds, byte[] data);
	}
}
